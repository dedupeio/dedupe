...
patent_file = 'patstat_dedupe_patent_input.csv'
...
rounds = [1, 2, 3]
recall_weights = [1, 1, 4]
ppcs = [0.001, 0.001, 0.001]
dupes = [10, 5, 5]
twostage = [False, False, True]
#dupes = [10, 5, 1]
    ...
    if idx == 0:
        ...
        if r_twostage:
            ...
            addl_idx = patent_util.find_potential_matches(consolidated_input, 'Name',
                                                          df_input.drop(consolidated_input.index, axis=0),
                                                          'Name',
                                                          0.95
                                                          )
            addl_data =df_input.ix[addl_index]
            addl_consolidated = patent_util.consolidate(addl_data,
                                                        cluster_name,
                                                        cluster_agg_dict
                                                        )
