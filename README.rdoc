...
[![Build Status](https://travis-ci.org/open-city/dedupe].png)](https://travis-ci.org/open-city/dedupe])
...
* Join our Goolge group for updates: https://groups.google.com/forum/?fromgroups=#!forum/open-source-deduplication  
