...
from dedupe import predicate_functions as fn  # type: ignore
...
class TestPredicateFunctions(unittest.TestCase):
    ...
    def test_first_token_predicate(self):
        ...
        assert fn.firstTokenPredicate(" cip   ciop ") == ()

    def test_two_tokens_predicate(self):
        assert fn.firstTwoTokensPredicate("donald") == ()
        ...
        assert fn.firstTwoTokensPredicate(" cip   ciop ") == ()
    ...
    def test_first_integer_predicate(self):
        assert fn.firstIntegerPredicate("donald 456") == ()
    ...
    def test_common_two_tokens(self):
        ...
        assert fn.commonTwoTokens("g00fy  ") == set()
    ...
    def test_common_three_tokens(self):
        ...
        assert fn.commonThreeTokens("donald 1992") == set()
        assert fn.commonThreeTokens("g00fy  ") == set()
    ...
    def test_two_gram_fingerprint(self):
        ...
        assert fn.twoGramFingerprint("7") == ()
    ...
    def test_common_six_gram(self):
        ...
        assert fn.commonSixGram("g00fy  ") == set()
    ...
    def test_magnitude_of_cardinality(self):
        assert fn.magnitudeOfCardinality(range(0)) == ()
    ...
    def test_predicates_correctness(self):
        ...
        assert fn.commonTwoElementsPredicate((1,)) == set()
        assert fn.commonThreeElementsPredicate((1, 2, 3)) == {"1 2 3"}
        assert fn.commonThreeElementsPredicate((1,)) == set()
        ...
        assert fn.twoGramFingerprint("1") == ()
        assert fn.commonTwoTokens("foo bar") == {"foo bar"}
        assert fn.commonTwoTokens("foo") == set()
