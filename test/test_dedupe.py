...
class AffineGapTest(unittest.TestCase):
  ...
  def test_affine_gap_correctness(self):
    assert self.affineGapDistance(u'a', u'b', -5, 5, 5, 1, 0.5) == 5
    assert self.affineGapDistance(u'ab', u'cd', -5, 5, 5, 1, 0.5) == 10
    assert self.affineGapDistance(u'ab', u'cde', -5, 5, 5, 1, 0.5) == 13
    assert self.affineGapDistance(u'a', u'cde', -5, 5, 5, 1, 0.5) == 8.5
    assert self.affineGapDistance(u'a', u'cd', -5, 5, 5, 1, 0.5) == 8
    assert self.affineGapDistance(u'b', u'a', -5, 5, 5, 1, 0.5) == 5
    assert self.affineGapDistance(u'a', u'a', -5, 5, 5, 1, 0.5) == -5
    assert numpy.isnan(self.affineGapDistance(u'a', u'', -5, 5, 5, 1, 0.5))
    assert numpy.isnan(self.affineGapDistance(u'', u'', -5, 5, 5, 1, 0.5))
    assert self.affineGapDistance(u'aba', u'aaa', -5, 5, 5, 1, 0.5) == -5
    assert self.affineGapDistance(u'aaa', u'aba', -5, 5, 5, 1, 0.5) == -5
    assert self.affineGapDistance(u'aaa', u'aa', -5, 5, 5, 1, 0.5) == -7
    assert self.affineGapDistance(u'aaa', u'a', -5, 5, 5, 1, 0.5) == -1.5
    assert numpy.isnan(self.affineGapDistance(u'aaa', u'', -5, 5, 5, 1, 0.5))
    assert self.affineGapDistance(u'baa', u'abba', -5, 5, 5, 1, 0.5) == 1
    assert self.affineGapDistance(u'áaa', u'abba', -5, 5, 5, 1, 0.5) == 3

  def test_normalized_affine_gap_correctness(self):
    assert numpy.isnan(self.normalizedAffineGapDistance(u'', u'', -5, 5, 5, 1, 0.5))
